...
asciidoctor  -I /share/Git/asciidoctor-rouge/lib -r asciidoctor-rouge.rb -a rouge-css=external -a rouge-theme=../styles/rouge_github_simonis.css -a linkcss -a stylesheet=github_simonis.css -a stylesdir=./styles -a copycss=./styles/github_simonis.css --destination-dir github_simonis --out-file=cl4cds.html -r ./ruby/callout-macro.rb --trace 2018-01-14-cl4cds.adoc
////
